...
class Model(object):
	...
	print(outputs.shape)
	#print(states.shape)
        rnn_seq = tf.expand_dims(outputs, -1)  # shape: (batch x seq x rnn_size x 1)
        print("rnn_seq:"+str(np.shape(rnn_seq)))
	...
	print("logi:"+str(self.logits.shape))
